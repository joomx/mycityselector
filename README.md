...
> Не нужно создавать много сайтов :) это неверно. Подробнее о настройках домена можно прочитать [тут](https://github.com/art-programming-team/mycityselector/blob/develop/README.md).
...
Например, ваш сайт krakozyabra.org по умолчанию для города Красноярск. А остальные города на поддоменах:<br>
