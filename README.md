...
Представляет из себя таблицу состоящую изчетырех столбцов:

 - город по умолчанию - определяет какой город будет установлен по умолчанию, если его не удастся определить автоматически
 - название города или группы городов
 - название субдомена или URL-префикс для страниц (например "/moscow/" или "/spb/")
