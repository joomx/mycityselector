...
Текст отображаемый в заголовке диалогового окна выбоар города. Не знаю зачем, путь будет :)
...
Второй способ в общем-то делается также как и первый, но после дублирования также необходимо переименовать файлы шаблона (придумать свое имя для шаблона).
