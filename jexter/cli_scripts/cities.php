...
$regions = ['Республика Адыгея' => ['Майкоп'],
    'Республика Алтай' => ['Барнаул', 'Бийск', 'Рубцовск'],
...
'Мінск' => [ 'Мінск' ],
'Брэсцкая вобласць' => [ 'Брэст','Баранавічы','Пінск' ],
'Віцебская вобласць' => [ 'Ві́цебск','Орша','Наваполацк','По́лацк'],
'Гомельская вобласць' => [ 'Гомель' ,'Мазы́р','Жлобін','Светлагорск','Рэчыца'],
'Гродзенская вобласць' => [ 'Гродна' ,'Ліда'],
'Мінская вобласць' => [ 'Барысаў' ,'Салігорск','Маладзе́чна'],
'Магілёўская вобласць' => [ 'Магілёў','Бабру́йск' ],
...
foreach ($regions as $regionName => $region) {
    if (!empty($region)) {
        foreach ($region as $city) {
            $db->setQuery('SELECT id,country_id FROM #__mycityselector_region WHERE name='. $db->quote($regionName));
